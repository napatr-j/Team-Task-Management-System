...
export default function HeroSection() {
  return (
    <section
      id="hero"
      className="relative overflow-hidden rounded-[32px] border border-[#E7E6DD] bg-white/95 px-4 py-12 shadow-[0_35px_90px_rgba(17,24,39,0.08)] sm:px-6 lg:px-10"
    >
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-3xl border border-[#ECECEC] bg-[#F7F7F2] p-5 text-sm text-[#555] shadow-sm">
              <p className="font-medium text-[#1A1A1A]">
                Trusted by product, design, and operations teams.
              </p>
